...
const ZH: PackageLang = {
  ...
  prices: [{ group: '1 人', price: '6,500', unit: '元 / 人' }, { group: '2–3 人', price: '6,000', unit: '元 / 人' }, { group: '4 人', price: '5,000', unit: '元 / 人' }],
...
const KO: PackageLang = {
  ...
  heroDesc: '의료상담부터 한국 체류까지, 더 안심하고 방한하실 수 있도록 정리해 드립니다.',
  heroBtn: '컨시어지에게 연락',
  ...
  priceTitle: '기본 일정 가격',
  priceNote: '비용에는 차량, 병원 동행, 관광지 안내, 기본 일정 동행 포함.\n호텔, 의료비, 개인 소비 미포함.',
  prices: [{ group: '1인', price: '6,500', unit: '위안 / 인' }, { group: '2–3인', price: '6,000', unit: '위안 / 인' }, { group: '4인', price: '5,000', unit: '위안 / 인' }],
...
const EN: PackageLang = {
  ...
  heroDesc: 'From medical consultation to your stay in Korea — we plan a clearer, more comfortable 3-night 4-day journey for you.',
  ...
  priceTitle: 'Base Itinerary Price',
  priceNote: 'Includes vehicle, hospital escort, attraction visits, and basic itinerary support.\nExcludes hotel, medical costs, and personal expenses.',
  prices: [{ group: '1 person', price: '6,500', unit: 'CNY / person' }, { group: '2–3 people', price: '6,000', unit: 'CNY / person' }, { group: '4 people', price: '5,000', unit: 'CNY / person' }],
...
const AR: PackageLang = {
  ...
  heroTitle: 'باقة كيمديسبرينج 3 ليالٍ / 4 أيام',
  heroTag: 'استشارة طبية · مرافق مترجم · دعم الجدول · الإقامة في كوريا',
  heroDesc: 'من الاستشارة الطبية إلى إقامتك في كوريا — نخطط لرحلة أكثر وضوحاً وراحة من 3 ليالٍ و4 أيام.',
  ...
  priceTitle: 'سعر الجدول الأساسي',
  priceNote: 'يشمل السيارة، مرافقة المستشفى، زيارات المعالم، ودعم الجدول الأساسي.\nلا يشمل الفندق والتكاليف الطبية والمصاريف الشخصية.',
  prices: [{ group: '1 شخص', price: '6,500', unit: 'يوان صيني / شخص' }, { group: '2–3 أشخاص', price: '6,000', unit: 'يوان صيني / شخص' }, { group: '4 أشخاص', price: '5,000', unit: 'يوان صيني / شخص' }],
