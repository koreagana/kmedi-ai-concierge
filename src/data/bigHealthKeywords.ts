...
export const BIG_HEALTH_KEYWORDS: BigHealthKeyword[] = [
  {
    ...
    tests: [
      { zh: '甲状腺功能检查（甲功五项）', en: 'Thyroid function test (5-panel)' },
      { zh: '维生素D检查', en: 'Vitamin D test' },
      { zh: '铁蛋白与铁代谢检查', en: 'Ferritin and iron metabolism test' },
      { zh: '慢性炎症指标检查', en: 'Chronic inflammation marker test' },
      { zh: '功能医学相关评估', en: 'Functional medicine assessment' },
      { zh: '维生素B群评估', en: 'Vitamin B complex assessment' },
      { zh: '抗氧化与营养状态评估', en: 'Antioxidant and nutritional status assessment' },
    ],
    directionLabel: DIRECTION_LABEL,
    direction: [
      { zh: '疲劳原因评估', en: 'Fatigue cause assessment' },
      { zh: '甲状腺功能相关咨询', en: 'Thyroid function consultation' },
      { zh: '维生素D缺乏相关咨询', en: 'Vitamin D deficiency consultation' },
      { zh: '铁代谢与隐性缺铁咨询', en: 'Iron metabolism and hidden iron deficiency consultation' },
      { zh: '慢性炎症相关咨询', en: 'Chronic inflammation consultation' },
