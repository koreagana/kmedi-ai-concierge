...
/** 언어에 맞는 WhatsApp 연결 URL 반환 — zh는 리디아님, en은 알라 박사님 번호로 연결됨 */
export function getWhatsappUrl(lang: string) {
  return lang === 'zh' ? WHATSAPP_URL_OWNER : WHATSAPP_URL
}
