...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'pharmicell-ampoule',
    category: 'skincare',
    categoryLabel: { ko: '병원 화장품', zh: '院线护肤' },
    badge: 'new',
    emoji: '💉',
    nameKo: '플레이 셀 판테놀 힐러 앰플',
    nameZh: '干细胞培养液修复安瓶精华',
    priceKrw: 59000,
    priceCnyLabel: '¥ 约310元',
    recommendFor: [
      { ko: '성형·레이저 시술 후 빠른 재생을 원하는 분', zh: '整形·激光术后，希望皮肤快速再生修复的人' },
      { ko: '30대 이후 피부 탄력과 주름이 걱정되는 분', zh: '30岁以后，担心皮肤弹性下降和皱纹出现的人' },
      { ko: '여러 제품을 써봤지만 효과를 못 느낀 분', zh: '尝试过多种产品但效果不明显的人' },
      { ko: '과학적으로 검증된 성분의 고농도 앰플을 원하는 분', zh: '希望使用科学验证成分的高浓度精华安瓶的人' },
      { ko: '민감성 피부지만 기능성 케어가 필요한 분', zh: '敏感肌但需要功能性护理产品的人' },
    ],
    usage: [
      { ko: '세안 후 토너로 피부결을 정돈한 뒤 사용', zh: '洁面后用爽肤水调理肤质，再使用安瓶' },
      { ko: '적당량(2~3방울)을 손바닥에 덜어 체온으로 따뜻하게 한 후 얼굴 전체에 펴 바름', zh: '取适量(2-3滴)于掌心，用体温温热后均匀涂抹全脸' },
      { ko: '손바닥으로 가볍게 눌러 흡수시키면 더욱 효과적', zh: '用掌心轻压帮助吸收，效果更佳' },
      { ko: '아침·저녁 세안 후 매일 사용, 집중 케어 기간에는 2회 레이어링 권장', zh: '建议每日早晚使用，集中护理期间推荐叠涂2次' },
      { ko: '시술 직후 사용 시 반드시 의사와 시작 시점을 상담', zh: '术后使用请务必咨询医生确认使用时机' },
    ],
    caution: [
      { ko: '이상이 있으면 즉시 사용 중단 후 상담원에게 연락', zh: '出现异常请立即停用并联系顾问' },
      { ko: '어린이 손에 닿지 않는 곳에 보관', zh: '请放在儿童不易触及的地方' },
      { ko: '직사광선을 피해 서늘한 곳에 보관', zh: '避光阴凉处保存' },
      { ko: '개봉 후 6개월 이내 사용 권장', zh: '开封后建议6个月内使用' },
    ],
  },
  {
    id: 'pharmicell-cream',
