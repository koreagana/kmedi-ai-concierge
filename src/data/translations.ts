...
export const translations: Record<LangCode, Translations> = {
  ...
  ko: {
    ...
    concierge2Name: '김현우',
    concierge2Title: 'Health & Medical Concierge',
    concierge2Specialty: '항노화·건강관리 · 남성건강 · 재생의학 · 의료관광',
    concierge2Btn: '김현우와 상담',
    concernTitle: '이번에 가장 해결하고 싶은 것은?',
    concern1: '좀 더 젊고 생기 있어 보이고 싶다', concern1Sub: '항노화 외모 · 피부 리프팅 · 젊은 인상 관리',
    concern2: '몸속 노화 속도를 늦추고 싶다', concern2Sub: '기능의학 · 대사 관리 · 수면과 호르몬 · 생활방식',
    concern3: '한국의 합법적인 재생의학 상담을 알고 싶다', concern3Sub: '재생의학 · 관절건강 · 회복관리 · 합법 상담',
    concern4: '얼굴 라인, 턱선, 전체 분위기를 개선하고 싶다', concern4Sub: '턱선 · 윤곽 · 리프팅 · 볼륨 지지',
    concern5: '성형에 관심 있어, 전문적인 안내가 필요하다', concern5Sub: '눈 · 코 · 윤곽 · 젊어지는 성형 · 회복 계획',
    concern6: '피곤해 보이는 인상과 생기 없는 상태를 개선하고 싶다', concern6Sub: '눈 주위 · 다크서클 · 칙칙한 피부 · 체력 상태',
    concern7: '병원, 통역, 한국 일정이 걱정된다', concern7Sub: '예약 · 통역 · 차량 · 일정 · 동행 지원',
    concern8: '한국 체검과 중국 체검, 주요 차이가 궁금하다', concern8Sub: '정밀검진 · 기능의학 · 전문과 상담 · 결과 설명',
    categoryTitle: '의료 항목을 선택하세요',
    homeCardSectionTitle: '먼저 나의 한국 의료 상담카드를 만들어보세요',
    homeCardSectionDesc: '아직 어떤 항목을 선택해야 할지 모르겠다면, 몇 가지 질문으로 먼저 상담 방향을 정리해보세요.',
    homeCardSectionBtn: '상담카드 만들기',
  ...
  ar: {
    ...
    concierge2Specialty: 'مكافحة الشيخوخة وإدارة الصحة · صحة الرجل · الطب التجديدي · السياحة الطبية',
    concierge2Btn: 'تواصل مع كيم هيونوو',
    concernTitle: 'ما الذي تبحث عنه اليوم؟',
    concern1: 'أريد أن أبدو أصغر سناً وأكثر حيوية', concern1Sub: 'مظهر مكافحة الشيخوخة · رفع البشرة · إدارة المظهر الشاب',
    concern2: 'أريد إبطاء الشيخوخة من الداخل', concern2Sub: 'الطب الوظيفي · التمثيل الغذائي · النوم والهرمونات · نمط الحياة',
    concern3: 'أريد معرفة استشارة الطب التجديدي القانونية في كوريا', concern3Sub: 'الطب التجديدي · صحة المفاصل · التعافي · استشارة قانونية',
    concern4: 'أريد تحسين خط وجهي وفكي ومظهري العام', concern4Sub: 'خط الفك · الملامح · الرفع · دعم الحجم',
    concern5: 'أنا مهتم بالجراحة التجميلية وأحتاج إلى توجيه متخصص', concern5Sub: 'العيون · الأنف · الملامح · جراحة مُجدِّدة للشباب · خطة التعافي',
    concern6: 'أريد تحسين مظهر التعب والشحوب وانخفاض الحيوية', concern6Sub: 'منطقة العيون · الهالات · شحوب البشرة · مستوى الطاقة',
    concern7: 'قلق بشأن المستشفى والترجمة وجدول رحلتي لكوريا', concern7Sub: 'المواعيد · الترجمة · المواصلات · البرنامج · المرافقة',
    concern8: 'ما الفرق الرئيسي بين الفحص الطبي الكوري وفحص بلدي؟', concern8Sub: 'فحص دقيق · الطب الوظيفي · استشارة متخصصة · النتائج',
    categoryTitle: 'تصفح الخدمات الطبية',
    homeCardSectionTitle: 'ابدأ بإنشاء ملف استشارتك الطبية في كوريا',
    homeCardSectionDesc: 'إذا لم تكن متأكداً من الخدمة المناسبة، أجب عن بعض الأسئلة البسيطة وسنساعدك في توضيح اتجاه الاستشارة الأولي.',
    homeCardSectionBtn: 'إنشاء ملفي',
