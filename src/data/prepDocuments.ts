...
export const PREP_DOCUMENTS: PrepDocument[] = [
  ...
  {
    titleKo: '메이투안·따중디엔핑 입점·운영 부속협약서',
    titleZh: '美团·大众点评 入驻及运营补充协议',
    type: 'agreement',
    category: 'admin_contract',
    field: '美团 폴더',
    link: '/docs/meituan-contract.html',
    status: 'available',
    description: '「외국인환자 유치 업무협약서」의 부속협약 — 입점비·광고비·환자유치 수수료 규정, 별첨1(계정 운영 수권서) 포함',
  },
  {
