/* ══════════════════════════════════════════════════════════════════
   ...
   经济型 = 리베리 강남점 · 标准型 = 원셀의원 · 高端型 = 리앤장
   근거 문서: public/docs/pricing.html (구 한강애봄_수가비교표.html) / pricing_tiers.json

   [2026-09-11] 가격 출처를 public/docs/pricing.html 의 비교 대상 병원으로 한정.
   실제로 고객을 보내는 곳만 싣는다 — 다른 협력병원(도자기·온테나 등) 수가는
   견적에 쓰지 않는다. 화면 등급 구성:
     · 经济型 = 리베리 강남점      · 标准型 = 원셀의원(우선 배정)
     · 高端型 = 리앤장
   셀온은 제외했으므로 高端 값은 리앤장 단일 기준이다.
   5개 병원 어디에도 해당 사양이 없는 항목은 값을 비워 두면 화면에
   '咨询后告知'(상담 후 안내)로 표시된다. 값을 추정해 채우지 않는다.
   */
...
export const QUOTE_CATEGORIES: QuoteCategory[] = [
  {
    ...
    procedures: [
      { id: 'ulthera-prime', nameKo: '울쎄라피 프라임', nameZh: '超声刀 Ulthera', nameEn: 'Ultherapy PRIME', options: [
        { unit: '100发', unitEn: '100 shots', economy: { low: 430000, high: 430000 }, standard: { low: 460000, high: 460000 }, premium: { low: 755000, high: 755000 } },
        { unit: '300发', unitEn: '300 shots', economy: null, standard: { low: 1250000, high: 1250000 }, premium: { low: 1527000, high: 1527000 } },
        { unit: '400发', unitEn: '400 shots', economy: null, standard: { low: 1600000, high: 1600000 }, premium: null },
        { unit: '600发', unitEn: '600 shots', economy: null, standard: { low: 2400000, high: 2400000 }, premium: { low: 2827000, high: 2827000 } },
      ] },
      ...
      { id: 'thermage-flx', nameKo: '써마지 FLX', nameZh: '热玛吉FLX', nameEn: 'Thermage FLX', options: [
        { unit: '300发', unitEn: '300 shots', economy: null, standard: { low: 1490000, high: 1490000 }, premium: { low: 1764000, high: 1764000 } },
        { unit: '600发', unitEn: '600 shots', economy: { low: 1990000, high: 1990000 }, standard: { low: 2400000, high: 2400000 }, premium: { low: 2945000, high: 2945000 } },
        { unit: '900发', unitEn: '900 shots', economy: null, standard: { low: 2790000, high: 2790000 }, premium: { low: 4127000, high: 4127000 } },
      ] },
      ...
      { id: 'shurink-universe', nameKo: '슈링크 유니버스', nameZh: 'Shurink 聚焦超声', nameEn: 'Shurink Universe', options: [
        ...
        { unit: '300发', unitEn: '300 shots', economy: { low: 150000, high: 150000 }, standard: null, premium: null },
        { unit: '600发', unitEn: '600 shots', economy: null, standard: null, premium: null },
      ] },
  ...
  },
  {
    ...
    procedures: [
      ...
      { id: 'filler-juvederm', nameKo: '필러 쥬비덤', nameZh: '乔雅登 Juvederm', nameEn: 'Juvederm Filler', options: [
        { unit: '1cc', unitEn: '1cc', note: '美国品牌，质地紧实，适合塑形（下巴、鼻部等）', noteEn: 'US brand · firm texture, holds shape well for the chin and nose', economy: { low: 450000, high: 450000 }, standard: { low: 429000, high: 429000 }, premium: { low: 573000, high: 573000 } },
      ] },
      ...
      { id: 'filler-restylane', nameKo: '필러 레스틸렌', nameZh: '瑞蓝 Restylane', nameEn: 'Restylane Filler', options: [
        { unit: '1cc', unitEn: '1cc', note: '瑞典品牌，弹性适中，应用范围广泛', noteEn: 'Swedish brand · balanced elasticity, works across a wide range of areas', economy: { low: 400000, high: 400000 }, standard: { low: 429000, high: 429000 }, premium: { low: 618000, high: 618000 } },
      ] },
      { id: 'wrinkle-botox-domestic', nameKo: '주름보톡스 (국산)', nameZh: '韩版除皱肉毒素', nameEn: 'Wrinkle Botox (Korean brand)', options: [
        { unit: '单部位', unitEn: 'Per area', economy: { low: 19000, high: 19000 }, standard: { low: 35000, high: 35000 }, premium: { low: 36000, high: 36000 } },
      ] },
      { id: 'wrinkle-botox-xeomin', nameKo: '주름보톡스 (제오민)', nameZh: 'Xeomin 除皱肉毒素', nameEn: 'Wrinkle Botox (Xeomin)', options: [
        { unit: '单部位', unitEn: 'Per area', economy: { low: 79000, high: 79000 }, standard: { low: 70000, high: 70000 }, premium: { low: 109000, high: 109000 } },
      ] },
      { id: 'jaw-botox-domestic', nameKo: '사각턱보톡스 (국산)', nameZh: '韩版瘦脸针', nameEn: 'Jawline Slimming Botox (Korean brand)', options: [
        { unit: '50U', unitEn: '50 units', economy: { low: 29000, high: 29000 }, standard: { low: 55000, high: 55000 }, premium: { low: 45000, high: 45000 } },
      ] },
      { id: 'jaw-botox-xeomin', nameKo: '사각턱보톡스 (제오민)', nameZh: 'Xeomin 瘦脸针', nameEn: 'Jawline Slimming Botox (Xeomin)', options: [
        { unit: '50U', unitEn: '50 units', economy: { low: 150000, high: 150000 }, standard: { low: 129000, high: 129000 }, premium: { low: 255000, high: 255000 } },
      ] },
      { id: 'skin-botox-domestic', nameKo: '스킨보톡스 (국산)', nameZh: '韩版水光肉毒素', nameEn: 'Skin Botox (Korean brand)', options: [
        { unit: '全脸', unitEn: 'Full face', economy: { low: 90000, high: 90000 }, standard: { low: 150000, high: 150000 }, premium: { low: 127000, high: 127000 } },
      ] },
    ],
  },
  {
    ...
    procedures: [
      { id: 'laser-toning', nameKo: '레이저 토닝', nameZh: '激光祛斑 Toning', nameEn: 'Laser Toning', options: [
        { unit: '1次', unitEn: '1 session', economy: { low: 100000, high: 100000 }, standard: { low: 200000, high: 200000 }, premium: { low: 155000, high: 155000 } },
      ] },
  ...
  },
  {
    ...
    procedures: [
      ...
      { id: 'ldm-lifting', nameKo: 'LDM 물방울리프팅', nameZh: 'LDM 水滴提升', nameEn: 'LDM Water Drop Lifting', options: [
        { unit: '12分钟', unitEn: '12 min', economy: { low: 80000, high: 80000 }, standard: { low: 99000, high: 99000 }, premium: { low: 91000, high: 91000 } },
      ] },
    ],
  },
]
